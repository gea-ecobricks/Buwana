...
<!-- BETA (June): isolated layout/UX refinement stylesheet. Scoped under .login-beta so it
     only affects this page; overrides global rules via specificity, not source order. -->
<link rel="stylesheet" href="../styles/login-beta-june.css?v=<?php echo $version; ?>">
...
<div class="page-panel-group login-beta">
   ...
   <!-- Form starts here-->
        <form id="login" method="post" action="../processes/login_process_jwt.php">
            ...
            <div class="form-item lb-item-top">
                <div id="credential-input-field" class="input-wrapper lb-float">
                    <input type="text" id="credential_key" name="credential_key" autocomplete="username" required placeholder=" " value="<?= htmlspecialchars($credential_key) ?>">
                    <label for="credential_key" class="lb-label">Email</label>
                    <span class="toggle-select-key">🌏</span>
            ...
            <div class="form-item lb-item-bottom" id="password-form">
                <div class="password-wrapper lb-float">
                    <input type="password" id="password" name="password" autocomplete="current-password" placeholder=" " required>
                    <label for="password" class="lb-label" data-lang-id="005-password-field-placeholder">Password</label>
            ...
            <div class="form-item lb-item-bottom" id="code-form">
            ...
            <p id="code-status" class="form-caption" data-lang-id="003-code-status">A code to login will be sent to your email.</p>

            </div>

            <div class="lb-login-buttons" id="login-buttons">
                 <div class="toggle-container">
                                            <input type="radio" id="toggle-password" name="toggle" value="password" checked>
                                            <input type="radio" id="toggle-code" name="toggle" value="code">
                ...
                <div id="code-error" data-lang-id="002-password-wrong" class="form-field-error">👉 Entry is incorrect.</div>
            </div>
        </form>
    </div>

    <div class="lb-signup-link">
            <p data-lang-id="000-no-account-yet">Don't have an account yet? <a href="signup-1.php?app=<?= urlencode($app_info['client_id']) ?>">Signup!</a></p>
    </div>
...
<script src="../js/login-beta-june.js?v=<?php echo ($version); ;?>4" defer></script>
